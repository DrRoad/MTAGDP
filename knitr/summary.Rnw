...
For each Regional Council and Industry combination, these diagrams provide a visual diagnostic to the distribution of GDP across finer scale geographic regions (i.e. Territorial Authorities) and industries.
